...
def run_diagnosis_agents(
    ...
    try:
        ...
        analysis_output = AnalysisOutput(
            ...
            start_time=datetime.fromisoformat(start_time).isoformat() if isinstance(start_time, str) else start_time.isoformat(),
            end_time=datetime.now(timezone.utc).isoformat(),
            processing_duration=str((datetime.now(timezone.utc) - (datetime.fromisoformat(start_time) if isinstance(start_time, str) else start_time)).total_seconds()),
